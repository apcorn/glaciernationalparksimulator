...
public class ParkingTier implements Comparable<ParkingTier>
{
	public final int tier;
	public final int capacity;
	public final int timeLimit;
	
	public ParkingTier( int tier, int capacity, int timeLimit )
	{
		this.tier = tier;
	...
	public int compareTo( ParkingTier o )
	{
		Integer me = new Integer( tier );
		Integer other = new Integer( o.tier );
